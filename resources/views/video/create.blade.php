...
<div class="form-container">
    <div class="form-header flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Add New Video</h1>
    ...
    <form id="videoForm" class="space-y-6" method="POST" action="{{ route('video.store') }}" enctype="multipart/form-data">
        @csrf
...
document.getElementById('videoForm').addEventListener('submit', function(e) {
    ...
    .catch(error => {
        ...
        submitButton.innerHTML = '<i class="fas fa-save mr-2"></i> Save Video';
    });
});
</script>
@endpush
