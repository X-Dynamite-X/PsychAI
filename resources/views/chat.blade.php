...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (message) {
            ...
            setTimeout(() => {
                ...
                addMessage('شكراً لمشاركتك. كيف يمكنني مساعدتك بشكل أفضل؟', 'ai');
            }, 1500);
        }
    });
    ...
    function showTypingIndicator() {
        ...
        typingDiv.className = 'flex items-start space-x-4 space-x-reverse max-w-3xl mx-auto mt-4';
        typingDiv.innerHTML = `
    ...
    function addMessage(message, type) {
        ...
        messageDiv.className = `flex items-start ${type === 'user' ? 'flex-row-reverse' : ''} space-x-4 space-x-reverse max-w-3xl mx-auto mt-4`;
        
        const gradientBg = type === 'user' ? 'from-emerald-500 to-emerald-600' : 'from-blue-500 to-blue-600';
        const messageBg = type === 'user' ? 'bg-emerald-50 dark:bg-gray-700' : 'bg-white dark:bg-gray-800';
        ...
        messageDiv.innerHTML = `
            ...
            <div class="flex-1">
                ...
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400 ${type === 'user' ? 'ml-2 text-left' : 'mr-2'}">${time}</div>
            </div>
        `;
