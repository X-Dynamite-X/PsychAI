<div id="deleteModal-{{ $user->id }}" tabindex="-1"
    class="deleteModal hidden fixed inset-0 z-50 flex items-center justify-center  bg-opacity-50">
    <div class="relative w-full max-w-md p-4">
        <div class="relative bg-white rounded-lg shadow-lg dark:bg-gray-700">
            <button type="button" id="closeDeleteModal"
                class="closeDeleteModal absolute top-3 right-3 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
